                  ...
                  <div className="logo-search-category-wrapper">
                    ...
                    <div className="category-search-wrapper">
                      <div className="category-btn category-hover-header">
                        <img className="parent" src="/templates/supermarket2/icons/bar-1.svg" alt="icons" />
                      ...
                      <div className="category-btn category-hover-header">
                        ...
                        <ul className="category-sub-menu">
                          {["Breakfast & Dairy","Meats & Seafood","Breads & Bakery","Chips & Snacks","Medical Healthcare","Grocery & Staples","Biscuits & Snacks","Frozen Foods","Other Items"].map((cat, i) => (
                            <li key={i}><a href="#" className="menu-item"><img src={`/templates/supermarket2/icons/0${i+1 > 9 ? 9 : i+1}.svg`} alt="icons" /><span>{cat}</span></a></li>
                          ))}
                        </ul>
                      </div>
