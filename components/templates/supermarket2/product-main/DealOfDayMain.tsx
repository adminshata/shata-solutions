...
const DealOfDayMain: React.FC<Props> = ({ Slug, ProductImage, ProductTitle, Price }) => {
  ...
  const handleAdd = () => addToCart({ id: Date.now(), image: `/templates/supermarket2/products/${ProductImage}`, title: ProductTitle ?? 'Product', price: Price ? parseFloat(Price) : 0, quantity: 1, active: true });
