                    ...
                    <div className="flex flex-1 flex-col justify-between min-w-0">
                      <div className="flex items-start justify-between gap-2">
                        <Link
                          ...
                          onClick={cart.closeDrawer}
                          className="text-sm font-semibold text-gray-800 hover:text-[#DC2626] line-clamp-2"
                        >
                          {product.name}
                        </Link>
                        <button
          ...
          <footer className="border-t border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                href={`${BASE_PATH}/cart`}
                onClick={cart.closeDrawer}
                className="block w-full rounded border border-gray-200 bg-white py-2.5 text-center text-sm font-semibold text-gray-700 hover:border-[#DC2626] hover:text-[#DC2626] transition-colors"
              >
                View Cart
              </Link>
            </div>
