    ...
    <div className="group relative bg-white rounded border border-gray-100 hover:shadow-md transition-shadow overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
          <div className="flex gap-2">
            <button
              type="button"
              onClick={handleAdd}
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md text-[#DC2626] hover:bg-[#DC2626] hover:text-white transition-colors"
              title="Add to cart"
            >
      ...
      <div className="p-3">
        ...
        <Link
          ...
          className="block text-sm font-semibold text-gray-800 hover:text-[#DC2626] line-clamp-2 leading-snug"
        >
          {product.name}
        </Link>
        {product.unit && (
        ...
        <button
          ...
          style={
            inCart
              ...
              : { background: "transparent", color: "#DC2626", borderColor: "#DC2626" }
          }
        >
