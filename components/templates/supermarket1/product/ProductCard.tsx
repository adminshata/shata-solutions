...
import { formatPrice, lineSignature } from "@/lib/supermarket1/utils";
import type { Product } from "@/lib/supermarket1/types";
    ...
    <div className="group relative bg-white rounded border border-gray-100 hover:shadow-md transition-shadow overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
          <div className="flex gap-2">
            <button
              type="button"
              onClick={handleAdd}
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md text-[#629D23] hover:bg-[#629D23] hover:text-white transition-colors"
              title="Add to cart"
            >
      ...
      <div className="p-3">
        ...
        <Link
          ...
          className="block text-sm font-semibold text-gray-800 hover:text-[#629D23] line-clamp-2 leading-snug"
        >
          {product.name}
        </Link>
        {product.unit && (
        ...
        <div className="mt-2 flex items-center gap-2">
          <span className="text-base font-bold" style={{ color: "#629D23" }}>
        ...
        <button
          ...
          style={
            inCart
              ...
              : { background: "transparent", color: "#629D23", borderColor: "#629D23" }
          }
        >
