    ...
    <div>
      <div id="side-bar" className="side-bar header-two">
        ...
        <form action="#" className="search-input-area-menu mt--30">
          ...
          <button><i className="fa-light fa-magnifying-glass" /></button>
        </form>
        ...
        <div className="button-area-main-wrapper-menuy-sidebar mt--50">
          <div className="contact-area">
            ...
            <div className="phone">
              ...
              <a href="#">hello@freshmart.com</a>
            </div>
          </div>
          <div className="buton-area-bottom">
            <Link href={`${BASE_PATH}/login`} className="rts-btn btn-primary">Sign In</Link>
            <Link href={`${BASE_PATH}/register`} className="rts-btn btn-primary">Sign Up</Link>
          </div>
        </div>
      </div>
