          ...
          <div className="col-lg-12">
              ...
              <div className="single-footer-wized">
                ...
                <div className="call-area">
                  ...
                  <div className="info">
                    ...
                    <a href="tel:+15555678901" className="number">+1 (555) 567-8901</a>
                  </div>
                </div>
            ...
            <div className="social-and-payment-area-wrapper">
              ...
              <div className="payment-access">
                ...
                <img src="/templates/supermarket5/payment/06.png" alt="Payment methods" />
              </div>
            </div>
          </div>
        </div>
...
function FooterLinks({ title, links }: { title: string; links: [string, string][] }) {
  return (
    <div className="single-footer-wized">
      <h3 className="footer-title animated fadeIn">{title}</h3>
