            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="bwtween-area-header-top header-top-style-four">
                  ...
                  <p>Welcome to our Organic store VividMart!</p>
                      ...
                      <div className="col-lg-12">
                        <div className="logo-search-category-wrapper style-five-call-us">
                          <Link href={BP} className="logo-area">
                            <span className="logo vividmart-logo">VividMart</span>
                          </Link>
                          <div className="category-search-wrapper style-five">
                            <div className="location-area">
                              <div className="icon"><i className="fa-regular fa-phone-volume" /></div>
                              <div className="information">
                                <span>Hotline Number</span>
                                <a href="tel:+15555678901"><p>+1 (555) 567-8901</p></a>
                              </div>
                            </div>
                            <form onSubmit={submitSearch} className="search-header" autoComplete="off" style={{ position: "relative" }}>
                              ...
                              {showSuggestions && suggestions.length > 0 && (
                                <ul className="autocomplete-suggestions" style={{ position: "absolute", backgroundColor: "#fff", border: "1px solid #ddd6fe", marginTop: 4, width: "100%", maxHeight: 220, overflowY: "auto", zIndex: 1000, listStyleType: "none", padding: 0, borderRadius: 6 }}>
                ...
                <div className="nav-and-btn-wrapper">
                  <div className="nav-area-bottom-left-header-four">
                    <div className="category-btn category-hover-header five-style">
                      <img className="parent" src="/templates/supermarket5/icons/14.svg" alt="icons" />
                  ...
                  <div className="right-btn-area header-five">
                    <Link href={`${BP}/shop`} className="btn-narrow">Trending Products</Link>
                    <Link href={`${BP}/shop`} className="rts-btn btn-primary">Get 30% Discount Now <span>Sale</span></Link>
                  </div>
                </div>
              </div>
              <div className="col-lg-12">
                <div className="logo-search-category-wrapper after-md-device-header header-mid-five-call">
                  <Link href={BP} className="logo-area"><span className="logo vividmart-logo small">VividMart</span></Link>
                  <div className="category-search-wrapper">
                    ...
                    <form onSubmit={submitSearch} className="search-header">
                      <input type="text" placeholder="Search for products, categories or brands" value={searchTerm} onChange={(event) => setSearchTerm(event.target.value)} />
                      <button type="submit" className="rts-btn btn-primary radious-sm with-icon">
