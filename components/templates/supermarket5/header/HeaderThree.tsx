                  ...
                  <div className="category-search-wrapper">
                    ...
                    <form onSubmit={submitSearch} className="search-header" autoComplete="off" style={{ position: "relative" }}>
                      ...
                      {showSuggestions && suggestions.length > 0 && (
                        <ul className="autocomplete-suggestions" style={{ position: "absolute", backgroundColor: "#fff", border: "1px solid #ede9fe", marginTop: 4, width: "100%", maxHeight: 220, overflowY: "auto", zIndex: 1000, listStyleType: "none", padding: 0, borderRadius: 6 }}>
