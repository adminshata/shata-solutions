...
import { PRODUCTS, POSTS, CATEGORIES } from "@/lib/supermarket5/defaults";
...
export function BannerThree() {
  const slides = [
    ...
    },
    {
      ...
      copy: "VividMart keeps fresh food, grocery staples, and daily offers ready for quick shopping.",
    },
  ];
