...
import { formatPrice, lineSignature } from "@/lib/supermarket3/utils";
import type { StoreProduct } from "@/lib/supermarket3/types";
    ...
    <div className="group relative bg-white rounded border border-gray-100 hover:shadow-md transition-shadow overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/10 transition-colors flex items-center justify-center opacity-0 group-hover:opacity-100">
          <div className="flex gap-2">
            <button
              type="button"
              onClick={handleAdd}
              className="flex h-9 w-9 items-center justify-center rounded-full bg-white shadow-md text-[#1D6CE3] hover:bg-[#1D6CE3] hover:text-white transition-colors"
              title="Add to cart"
            >
      ...
      <div className="p-3">
        ...
        <Link
          ...
          className="block text-sm font-semibold text-gray-800 hover:text-[#1D6CE3] line-clamp-2 leading-snug"
        >
          {product.name}
        </Link>
        {product.unit && (
        ...
        <div className="mt-2 flex items-center gap-2">
          <span className="text-base font-bold" style={{ color: "#1D6CE3" }}>
        ...
        <button
          ...
          style={
            inCart
              ...
              : { background: "transparent", color: "#1D6CE3", borderColor: "#1D6CE3" }
          }
        >
