              ...
              <div className="col-lg-12">
                <div className="logo-search-category-wrapper">
                  <Link href={BP} className="logo-area">
                    <span className="logo bluemart-logo">BlueMart</span>
                  </Link>
                  <div className="category-search-wrapper">
                    <div className="category-btn category-hover-header">
                      <img className="parent" src="/templates/supermarket3/icons/bar-1.svg" alt="icons" />
                    ...
                    <form onSubmit={submitSearch} className="search-header" autoComplete="off" style={{ position: "relative" }}>
                      ...
                      {showSuggestions && suggestions.length > 0 && (
                        <ul className="autocomplete-suggestions" style={{ position: "absolute", backgroundColor: "#fff", border: "1px solid #dbeafe", marginTop: 4, width: "100%", maxHeight: 220, overflowY: "auto", zIndex: 1000, listStyleType: "none", padding: 0, borderRadius: 6 }}>
          ...
          <div className="container-2">
            <div className="row">
              <div className="col-lg-12">
                ...
                <div className="logo-search-category-wrapper">
                  <Link href={BP} className="logo-area"><span className="logo bluemart-logo small">BlueMart</span></Link>
                  <div className="category-search-wrapper">
                    <div className="category-btn category-hover-header">
                      <img className="parent" src="/templates/supermarket3/icons/bar-1.svg" alt="icons" />
                      <span>Categories</span>
