          ...
          <footer className="border-t border-gray-200 bg-gray-50 px-5 py-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link
                href={`${BASE_PATH}/cart`}
                onClick={cart.closeDrawer}
                className="block w-full rounded border border-gray-200 bg-white py-2.5 text-center text-sm font-semibold text-gray-700 hover:border-[#1D6CE3] hover:text-[#1D6CE3] transition-colors"
              >
                View Cart
              </Link>
            </div>
