...
import { PRODUCTS, POSTS, CATEGORIES } from "@/lib/supermarket4/defaults";

const BP = "/templates/supermarket-4/preview";
const IMG = "/templates/supermarket4";
...
export function BannerThree() {
  const slides = [
    ...
    },
    {
      ...
      copy: "OrangeMart keeps fresh food, grocery staples, and daily offers ready for quick shopping.",
    },
  ];
