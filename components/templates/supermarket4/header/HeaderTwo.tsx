              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="hader-top-between-two">
                    <p>
                      Welcome to our Organic store OrangeMart! <span style={{ marginLeft: 12 }}>Get 30% Discount Now</span>
                    </p>
                      ...
                      <div className="category-btn category-hover-header">
                        ...
                        <ul className="category-sub-menu">
                          {["Breakfast & Dairy","Meats & Seafood","Breads & Bakery","Chips & Snacks","Medical Healthcare","Grocery & Staples","Biscuits & Snacks","Frozen Foods","Other Items"].map((cat, i) => (
                            <li key={i}><a href="#" className="menu-item"><img src={`/templates/supermarket4/icons/0${i+1 > 9 ? 9 : i+1}.svg`} alt="icons" /><span>{cat}</span></a></li>
                          ))}
                        </ul>
                      </div>
