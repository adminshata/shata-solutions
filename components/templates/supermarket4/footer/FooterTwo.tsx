                ...
                <div className="footer-two-main-wrapper">
                  <div className="footer-single-wixed-two start">
                    <Link href={BP} className="logo-area">
                      <span style={{ fontWeight: 700, fontSize: '22px', color: 'var(--color-primary)' }}>OrangeMart</span>
                    </Link>
                  ...
                  <div className="single-footer-wized mid">
                    ...
                    <div className="footer-nav">
                      <ul>
                        ...
                        <li><a href="#">Careers</a></li>
                        <li><a href="#">OrangeMart Stories</a></li>
                      </ul>
                    </div>
                  </div>
                  <div className="single-footer-wized">
                    ...
                    <div className="contact-information">
                      <div className="single-contact-information-area">
                        <div className="icon-area"><img src="/templates/supermarket4/icons/11.svg" alt="icons" /></div>
                        <div className="information-area"><p className="disc">258 Daniel Street, 2589 Phones Line <br />Berlin, Germany</p></div>
                      </div>
                      <div className="single-contact-information-area">
                        <div className="icon-area"><img src="/templates/supermarket4/icons/12.svg" alt="icons" /></div>
                        <div className="information-area"><p className="disc">Call us between 8:00 AM - 12PM <br /><a href="#">+25896 3158 3228</a></p></div>
                      </div>
                      <div className="single-contact-information-area">
                        <div className="icon-area"><img src="/templates/supermarket4/icons/13.svg" alt="icons" /></div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="copyright-arae-two-wrapper">
                  <p className="disc">Copyright 2025 <a href="#">©OrangeMart</a>. All rights reserved.</p>
                  <div className="payment-processw-area">
                    <span>Payment Accepts:</span>
                    <img src="/templates/supermarket4/payment/04.png" alt="payment" />
                  </div>
                </div>
              </div>
            </div>
