          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="footer-main-content-wrapper pb--70 pb_sm--30">
                ...
                <FooterLinks title="Shop Categories" links={[["Contact Us", "/contact"], ["Information", "/store"], ["About Us", "/about"], ["Vendors", "/vendors"], ["OrangeMart Stories", "/blog"]]} />
              ...
              <div className="social-and-payment-area-wrapper">
                ...
                <div className="payment-access">
                  ...
                  <img src="/templates/supermarket4/payment/01.png" alt="Payment methods" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="copyright-between-1">
                <p className="disc">Copyright 2026 <Link href={BP}>©OrangeMart</Link>. All rights reserved.</p>
                <a href="#" className="playstore-app-area">
                  <span>Download App</span>
                  <img src="/templates/supermarket4/payment/02.png" alt="App Store" />
                  <img src="/templates/supermarket4/payment/03.png" alt="Google Play" />
                </a>
              </div>
            </div>
          </div>
