...
export function buildProductsSchema(args: {
  ...
  return {
    labels: {
      ...
      emptyCopy: "Add your first BlueMart product.",
    },
    fields: {
      category: true,
...
const inputCls =
  "w-full rounded-lg border border-white/15 bg-white/[0.06] px-3 py-2 text-base text-white outline-none focus:border-[#1D6CE3]";
