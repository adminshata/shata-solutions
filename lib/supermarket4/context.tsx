...
export function useSite(): SiteConfig {
  ...
  if (!ctx) throw new Error("useSite must be used inside <Supermarket4Provider>");
  return ctx;
}
...
function SiteProvider({
  ...
  const value = config ?? SUPERMARKET4_DEFAULTS;
  return (
...
export const Supermarket4Provider = SiteProvider;
...
const CART_KEY = "supermarket4/cart";
...
export function useCart(): CartContextValue {
  ...
  if (!ctx) throw new Error("useCart must be used inside <Supermarket4Provider>");
  return ctx;
}
