...
export type Product = { id: string; handle: string; name: string; shortDescription?: string; description?: string; category?: string; images: string[]; badge?: ProductBadge; featured?: boolean; active?: boolean; price: Money; compareAtPrice?: Money; unit?: string; stock?: number; };
