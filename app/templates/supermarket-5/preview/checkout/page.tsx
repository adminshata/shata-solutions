...
import { useCart, useSite } from "@/lib/supermarket5/context";
import { formatPrice } from "@/lib/supermarket5/utils";
          ...
          <div className="container mx-auto px-4">
            {cart.cart.lines.length === 0 ? (
              <div className="flex flex-col items-center gap-4 bg-white rounded border border-gray-200 p-16 text-center">
                ...
                <Link href={`${BASE_PATH}/shop`} className="text-sm font-bold underline" style={{ color: "#7C3AED" }}>
                  Go to shop
                </Link>
              </div>
            ) : (
                    ...
                    <div className="bg-white rounded border border-gray-200 p-5">
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <select
                            name="country"
                            className="w-full rounded border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm outline-none focus:border-[#7C3AED]"
                          >
                  ...
                  <div className="lg:w-80 shrink-0">
                    <div className="bg-white rounded border border-gray-200 p-5 sticky top-4">
                      ...
                      <div className="space-y-2 text-sm border-t border-gray-100 pt-3">
                        ...
                        <div className="flex justify-between text-gray-600">
                          <span>Shipping</span>
                          <span className="font-semibold text-[#7C3AED]">{shipping === 0 ? "FREE" : formatPrice(shipping)}</span>
                        </div>
