                ...
                <form action="#" className="registration-form">
                  ...
                  <div className="another-way-to-registration">
                    ...
                    <div className="login-with-brand">
                      <a href="#" className="single"><img src="/templates/supermarket5/form/google.svg" alt="google" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                      <a href="#" className="single"><img src="/templates/supermarket5/form/facebook.svg" alt="facebook" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                    </div>
