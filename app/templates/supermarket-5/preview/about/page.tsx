        ...
        <div className="container">
          <div className="row g-5 align-items-center">
            <div className="col-lg-6">
              <img src="/templates/supermarket5/banner/01.webp" alt="about" style={{ width: '100%', borderRadius: 12 }} />
            </div>
            <div className="col-lg-6">
              <span style={{ color: 'var(--color-primary)', fontWeight: 600, fontSize: 14 }}>About VividMart</span>
              <h2 style={{ marginBottom: 20 }}>Fresh Groceries Delivered to Your Door</h2>
              <p style={{ color: '#666', lineHeight: 1.8, marginBottom: 20 }}>VividMart is your premium online grocery destination, bringing the freshest produce, finest meats, and everyday essentials right to your doorstep. Founded with a vision to make healthy eating accessible, we partner with local farms and trusted vendors.</p>
