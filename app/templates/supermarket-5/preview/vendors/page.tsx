              ...
              <div key={i} className="col-lg-4 col-md-6 col-12">
                <div className="single-vendor-area-start" style={{ background: '#fff', borderRadius: 8, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 16 }}>
                    <img src={`/templates/supermarket5/vendor/${v.img}`} alt={v.name} style={{ width: 64, height: 64, borderRadius: '50%', objectFit: 'cover' }} onError={e => { (e.target as HTMLImageElement).src = '/templates/supermarket5/products/01.jpg'; }} />
                    <div>
