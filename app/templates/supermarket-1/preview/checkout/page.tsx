          ...
          <div className="row">
            ...
            <div className="col-lg-8 pr--40 order-2 order-xl-1">
              <div className="coupon-input-area-1">
                <div className="coupon-area">
                  <div className="coupon-ask cupon-wrapper-1" onClick={() => setShowCoupon((prev) => !prev)}>
                    <button className="coupon-click" type="button">
            ...
            <div className="col-lg-4 order-1 order-xl-2">
              ...
              <div className="right-card-sidebar-checkout">
                  ...
                  cartItems.map((item) => (
                    <div className="single-shop-list" key={item.id}>
                      <div className="left-area">
                        ...
                        <span className="title">{item.title} &times; {item.quantity}</span>
                      </div>
                ...
                {discount > 0 && (
                  <div className="single-shop-list">
                    <div className="left-area"><span>Discount (25%)</span></div>
                ...
                <div className="cottom-cart-right-area">
                  ...
                  <Link href={`${BASE_PATH}/order-successful`} className="rts-btn btn-primary">Place Order</Link>
                </div>
              </div>
            </div>
          </div>
