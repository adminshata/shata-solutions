...
import { Quantity } from "@/components/templates/supermarket3/ui/Atoms";
import { useCart, useSite } from "@/lib/supermarket3/context";
  ...
  return (
    <SiteShell>
      ...
      <main style={{ background: "#F3F4F6" }}>
        {/* Banner */}
        <div style={{ background: "#1D6CE3" }} className="py-10">
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0">
                        ...
                        return (
                          <li key={sig} className="flex flex-col sm:grid sm:grid-cols-12 gap-3 sm:gap-4 p-4">
                            ...
                            <div className="col-span-6 flex items-center gap-3">
                              ...
                              <div className="min-w-0">
                                <Link
                                  ...
                                  className="text-sm font-semibold text-gray-800 hover:text-[#1D6CE3] line-clamp-2"
                                >
                                  {product.name}
                                </Link>
                                {product.unit && (
                            ...
                            <div className="col-span-2 flex sm:justify-end items-center gap-2">
                              ...
                              <span className="text-sm font-bold" style={{ color: "#1D6CE3" }}>
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <Link
                      href={`${BASE_PATH}/shop`}
                      className="flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-[#1D6CE3] transition-colors"
                    >
                ...
                <div className="lg:w-80 shrink-0">
                  <div className="bg-white rounded border border-gray-200 p-5 sticky top-4">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between text-gray-600">
                        <span>Shipping</span>
                        <span className="font-semibold text-[#1D6CE3]">
