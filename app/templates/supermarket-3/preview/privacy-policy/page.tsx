...
export default function PrivacyPolicyPage() {
  return (
    <ReferencePageShell title="Privacy Policy" subtitle="How BlueMart handles customer and delivery information.">
      <PolicyCopy />
    </ReferencePageShell>
  );
}
...
function PolicyCopy() {
  return (
    <div style={{ background: "#fff", borderRadius: 12, padding: 32, lineHeight: 1.9 }}>
      ...
      <p>BlueMart stores customer, account, order, delivery, and support details needed to process grocery purchases and marketplace vendor services.</p>
      <h4>How we use it</h4>
