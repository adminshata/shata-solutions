            ...
            <div className="col-lg-12">
              <div className="registration-wrapper-1">
                <div className="logo-area mb--0">
                  <span style={{ fontWeight: 700, fontSize: '24px', color: 'var(--color-primary)' }}>BlueMart</span>
                </div>
                ...
                <form action="#" className="registration-form">
                  ...
                  <div className="another-way-to-registration">
                    ...
                    <div className="login-with-brand">
                      <a href="#" className="single"><img src="/templates/supermarket3/form/google.svg" alt="google" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                      <a href="#" className="single"><img src="/templates/supermarket3/form/facebook.svg" alt="facebook" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                    </div>
