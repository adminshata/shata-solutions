            ...
            {vendors.map((v, i) => (
              <div key={i} className="col-12">
                <div style={{ background: '#fff', borderRadius: 8, padding: 24, boxShadow: '0 2px 12px rgba(0,0,0,0.08)', display: 'flex', alignItems: 'center', gap: 24 }}>
                  <img src={`/templates/supermarket3/vendor/${v.img}`} alt={v.name} style={{ width: 80, height: 80, borderRadius: '50%', objectFit: 'cover', flexShrink: 0 }} onError={e => { (e.target as HTMLImageElement).src = '/templates/supermarket3/products/01.jpg'; }} />
                  <div style={{ flex: 1 }}>
