        ...
        <section className="py-14">
          <div className="container mx-auto px-4">
            <div className="grid gap-10 lg:grid-cols-2 items-center">
              <div>
                <span className="text-xs font-bold uppercase tracking-widest text-[#1D6CE3]">Our Story</span>
            ...
            <div className="grid grid-cols-2 gap-6 sm:grid-cols-4">
              {STATS.map((s) => (
                <div key={s.label} className="text-center">
                  <div className="text-4xl font-extrabold" style={{ color: "#1D6CE3" }}>{s.value}</div>
        ...
        <section className="py-14">
          <div className="container mx-auto px-4">
            <div className="text-center mb-8">
              <span className="text-xs font-bold uppercase tracking-widest text-[#1D6CE3]">Our People</span>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={f.title} className="border border-gray-100 rounded p-5 text-center hover:border-[#1D6CE3]/30 hover:shadow-sm transition-all">
