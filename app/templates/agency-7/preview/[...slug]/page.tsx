...
import Agency7Frame from "../../../../../components/templates/agency7/Agency7Frame";
...
export default function Agency7InnerPage() {
  const params = useParams<{ slug?: string[] }>();
  const route = (params.slug ?? []).join("/");
  const page = resolvePage(route);

  return <Agency7Frame page={page} title={`Shata Cyber Security Agency ${route || "preview"}`} />;
}
