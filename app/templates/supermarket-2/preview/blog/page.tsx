...
export default function BlogPage() {
  return (
    <ReferencePageShell title="Blog" subtitle="QuickMart grocery tips, recipes, vendor stories, and fresh food ideas.">
          ...
          <div key={post.id} className="col-lg-4 col-md-6">
            <article className="single-blog-area-start" style={{ height: "100%" }}>
              <Link href={`${BASE_PATH}/blog/${post.slug}`} className="thumbnail">
                <img src={`/templates/supermarket2/blog/${post.image}`} alt={post.title} />
              </Link>
