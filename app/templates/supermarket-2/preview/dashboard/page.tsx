import { DashboardShell, StatCard, DataTable } from "@/components/templates/supermarket2/dashboard/DashboardShell";
  ...
  return (
    <DashboardShell title="Dashboard" subtitle="Reference ecommerce account and vendor overview.">
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <StatCard label="Products" value="238" note="QuickMart catalog" />
