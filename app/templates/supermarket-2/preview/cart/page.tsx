...
import { Quantity } from "@/components/templates/supermarket2/ui/Atoms";
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    <Link
                      href={`${BASE_PATH}/shop`}
                      className="flex items-center gap-2 text-sm font-semibold text-gray-600 hover:text-[#DC2626] transition-colors"
                    >
