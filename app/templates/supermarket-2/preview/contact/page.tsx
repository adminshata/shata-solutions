          ...
          <div className="row g-5">
            <div className="col-lg-4">
              <div className="contact-left-area-main-wrapper">
                ...
                {[{city:"Berlin Germany Store",addr:"259 Daniel Road, FKT 2589 Berlin, Germany.",phone:"+856 (76) 259 6328",email:"info@quickmart.com"},{city:"Frankfurt Germany Store",addr:"259 Daniel Road, FKT 2589 Frankfurt, Germany.",phone:"+856 (76) 259 6329",email:"frankfurt@quickmart.com"}].map((loc, i) => (
