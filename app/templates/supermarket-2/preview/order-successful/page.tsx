...
function OrderContent() {
  ...
  useEffect(() => {
    try {
      const raw = sessionStorage.getItem("sm2/order");
  ...
  return (
    <div className="max-w-lg mx-auto bg-white rounded border border-gray-200 p-8 text-center">
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link
          href={`${BASE_PATH}/shop`}
          className="rounded border border-gray-200 px-5 py-2.5 text-sm font-bold text-gray-700 hover:border-[#DC2626] hover:text-[#DC2626] transition-colors"
        >
          Continue Shopping
        </Link>
      </div>
