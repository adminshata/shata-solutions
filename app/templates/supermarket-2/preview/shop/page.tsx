            ...
            <aside className="w-full lg:w-56 shrink-0 space-y-4">
              ...
              <div className="bg-white rounded border border-gray-200 p-4">
                ...
                <input
                  ...
                  className="w-full rounded border border-gray-200 bg-gray-50 px-3 py-2 text-xs outline-none focus:border-[#DC2626]"
                />
              </div>
                  ...
                  <li>
                    <button
                      ...
                      className={`w-full text-left rounded px-2 py-1.5 text-sm transition-colors ${
                        selectedCategory === "" ? "text-[#DC2626] font-semibold" : "text-gray-600 hover:text-[#DC2626]"
                      }`}
                    >
                      All Products
                    </button>
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex flex-wrap items-center justify-between gap-3 bg-white rounded border border-gray-200 px-4 py-3 mb-5">
                <p className="text-sm text-gray-600">
                  ...
                  {selectedCategory && (
                    <> in <span className="font-semibold text-[#DC2626]">
                ...
                <select
                  ...
                  className="rounded border border-gray-200 bg-white px-3 py-1.5 text-xs outline-none focus:border-[#DC2626]"
                >
