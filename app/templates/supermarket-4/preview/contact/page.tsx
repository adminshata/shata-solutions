              ...
              <div className="bg-white rounded border border-gray-200 p-6">
                {sent ? (
                  <div className="flex flex-col items-center text-center gap-4 py-10">
                    <div className="flex h-16 w-16 items-center justify-center rounded-full" style={{ background: "#EA580C" }}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full rounded border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm outline-none focus:border-[#EA580C]"
                          />
                        </div>
                        <div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full rounded border border-gray-200 bg-gray-50 px-3 py-2.5 text-sm outline-none focus:border-[#EA580C] resize-none"
                        />
                      </div>
                      <button
                        type="submit"
