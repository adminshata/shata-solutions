          ...
          <div className="row g-5">
            <div className="col-lg-4">
              <div style={{ background: '#fff', borderRadius: 8, padding: 32, boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
                <span style={{ fontWeight: 700, fontSize: '22px', color: 'var(--color-primary)', display: 'block', marginBottom: 12 }}>OrangeMart</span>
                ...
                <p style={{ color: '#666' }}><i className="fa-light fa-envelope" /> info@orangemart.com</p>
