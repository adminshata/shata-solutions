...
import ShopMain from "@/components/templates/supermarket4/shop/ShopMain";
          ...
          <div className="row g-5">
            <div className="col-lg-4">
              <div style={{ background: '#fff', borderRadius: 8, padding: 32, boxShadow: '0 2px 12px rgba(0,0,0,0.08)', textAlign: 'center' }}>
                <img src="/templates/supermarket4/vendor/01.jpg" alt="vendor" style={{ width: 100, height: 100, borderRadius: '50%', objectFit: 'cover', marginBottom: 16 }} onError={e => { (e.target as HTMLImageElement).src = '/templates/supermarket4/products/01.jpg'; }} />
                <h4>{vendorName}</h4>
