...
import { findCategory, productsByCategory } from "@/lib/supermarket4/utils";
        ...
        <section className="py-8">
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              <Link
                href={`${BASE_PATH}/shop`}
                className="rounded-full border border-gray-200 bg-white px-4 py-1.5 text-xs font-semibold text-gray-600 hover:border-[#EA580C] hover:text-[#EA580C] transition-colors"
              >
                All
              </Link>
                ...
                <Link
                  ...
                  className={`rounded-full border px-4 py-1.5 text-xs font-semibold transition-colors ${
                    cat.handle === handle
                      ...
                      : "border-gray-200 bg-white text-gray-600 hover:border-[#EA580C] hover:text-[#EA580C]"
                  }`}
                  style={cat.handle === handle ? { background: "#EA580C" } : {}}
                >
                  {cat.name}
                </Link>
              ))}
