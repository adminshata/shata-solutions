            ...
            <div className="col-lg-12">
              <div className="registration-wrapper-1">
                <div className="logo-area mb--0">
                  <span style={{ fontWeight: 700, fontSize: '24px', color: 'var(--color-primary)' }}>OrangeMart</span>
                </div>
                <h3 className="title">Register Into Your Account</h3>
                <form action="#" className="registration-form">
                  <div className="input-wrapper"><label htmlFor="name">Username*</label><input type="text" id="name" /></div>
                  ...
                  <div className="another-way-to-registration">
                    <div className="registradion-top-text"><span>Or Register With</span></div>
                    <div className="login-with-brand">
                      <a href="#" className="single"><img src="/templates/supermarket4/form/google.svg" alt="google" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                      <a href="#" className="single"><img src="/templates/supermarket4/form/facebook.svg" alt="facebook" onError={e => { (e.target as HTMLImageElement).style.display='none'; }} /></a>
                    </div>
                    <p>Already have an account? <Link href={`${BASE_PATH}/login`}>Login</Link></p>
                  </div>
                </form>
              </div>
            </div>
