...
import Agency8Frame from "../../../../../components/templates/agency8/Agency8Frame";
...
export default function Agency8InnerPage() {
  const params = useParams<{ slug?: string[] }>();
  const route = (params.slug ?? []).join("/");
  const page = resolvePage(route);

  return <Agency8Frame page={page} title={`Shata SaaS & Startups ${route || "preview"}`} />;
}
